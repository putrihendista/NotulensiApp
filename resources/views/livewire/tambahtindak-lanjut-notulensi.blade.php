        ...
        <div class="bg-blueLight p-8 shadow-lg max-w-lg w-full">
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-4 py-2 bg-white text-blue font-bold rounded-md shadow hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400 font-semibold">
                        Save
                    </button>
                </div>
            </form>
